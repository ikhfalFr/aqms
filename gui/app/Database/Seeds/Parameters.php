...
class Parameters extends Seeder
{
	public function run()
	{
		...
		$data = [
			...
			['p_type' => 'particulate', 'code' => 'pm25', 'caption_id' => 'PM2.5', 'caption_en' => 'PM2.5',					'default_unit' => 'µg/m<sup>3</sup>', 'molecular_mass' => '', 	'formula' => 'round(explode(";",$sensor[3][3])[1], 2)/10', 'is_view' => '1', 'is_graph' => '1'],
			['p_type' => 'particulate_flow', 'code' => 'pm25_flow', 'caption_id' => 'PM2.5 Flow', 'caption_en' => 'PM2.5 Flow',		'default_unit' => 'l/mnt', 'molecular_mass' => '', 		'formula' => 'round(explode(";",$sensor[3][8])[], 2)', 'is_view' => '1', 'is_graph' => '1'],
			['p_type' => 'particulate', 'code' => 'pm10', 'caption_id' => 'PM10', 'caption_en' => 'PM10',					'default_unit' => 'µg/m<sup>3</sup>', 'molecular_mass' => '',   'formula' => 'round(explode(";",$sensor[3][7])[1], 2)/10', 'is_view' => '1', 'is_graph' => '1'],
			['p_type' => 'particulate_flow', 'code' => 'pm10_flow', 'caption_id' => 'PM10 Flow', 'caption_en' => 'PM10 Flow',		'default_unit' => 'l/mnt', 'molecular_mass' => '', 		'formula' => 'round(explode(";",$sensor[3][8])[1], 2)', 'is_view' => '1', 'is_graph' => '1'],
